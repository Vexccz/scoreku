    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="bg-[#111]/90 backdrop-blur-sm border border-[#1f1f1f] rounded-3xl p-8 shadow-2xl">
          ...
          <p className="text-gray-400 text-sm mb-8 text-center">Log in to view your credit score</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3.5 bg-[#0a0a0a] border border-[#2a2a2a] rounded-xl focus:outline-none focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/20 transition text-white placeholder-gray-600"
                  required
                />
              </div>
            </div>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.99 }}
              className="w-full py-3.5 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-500 hover:to-blue-600 rounded-xl font-semibold transition disabled:opacity-50 shadow-lg shadow-blue-600/20 flex items-center justify-center gap-2"
            >
              {loading ? (
