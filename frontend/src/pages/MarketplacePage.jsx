...
const products = [
  { id: 1, name: 'BSN Micro Loan', provider: 'Bank Simpanan Nasional', maxAmount: 50000, rate: '4% p.a.', minScore: 720, type: 'Micro-loan', tenure: '5 years', description: 'Micro financing for small businesses and entrepreneurs. Quick approval with minimal documentation.', icon: Banknote, logo: 'https://img.logo.dev/bsn.com.my?token=pk_free', brandColor: '#003d79' },
  { id: 2, name: 'TEKUN Nasional', provider: 'TEKUN Nasional', maxAmount: 100000, rate: '4% p.a.', minScore: 650, type: 'Business', tenure: '7 years', description: 'Business financing for Bumiputera entrepreneurs. Flexible repayment terms with mentoring support.', icon: Briefcase, logo: null, brandColor: '#1a5276' },
  { id: 3, name: 'Amanah Ikhtiar', provider: 'Amanah Ikhtiar Malaysia', maxAmount: 20000, rate: '0% (Islamic)', minScore: 530, type: 'Micro-loan', tenure: '3 years', description: 'Interest-free Islamic microfinancing for low-income entrepreneurs. Group lending model.', icon: Wallet, logo: null, brandColor: '#2e7d32' },
  { id: 4, name: 'MARA Business Financing', provider: 'MARA', maxAmount: 200000, rate: '3.5% p.a.', minScore: 700, type: 'Business', tenure: '10 years', description: 'Business development financing for Bumiputera SMEs. Includes business advisory services.', icon: Briefcase, logo: 'https://img.logo.dev/mara.gov.my?token=pk_free', brandColor: '#1565c0' },
  { id: 5, name: 'Bank Rakyat Personal', provider: 'Bank Rakyat', maxAmount: 150000, rate: '5.5% p.a.', minScore: 750, type: 'Personal', tenure: '10 years', description: 'Personal financing with competitive rates. Available for salaried and self-employed individuals.', icon: CreditCard, logo: 'https://img.logo.dev/bankrakyat.com.my?token=pk_free', brandColor: '#6B2D8B' },
  { id: 6, name: 'PTPTN Education', provider: 'PTPTN', maxAmount: 60000, rate: '1% p.a.', minScore: 450, type: 'Education', tenure: '15 years', description: 'Education loan for Malaysian students pursuing higher education at recognized institutions.', icon: GraduationCap, logo: 'https://img.logo.dev/ptptn.gov.my?token=pk_free', brandColor: '#0d47a1' },
  { id: 7, name: 'TEKUN Usaha Niaga', provider: 'Tabung Ekonomi Kumpulan Usaha Niaga', maxAmount: 50000, rate: '4% p.a.', minScore: 600, type: 'Business', tenure: '5 years', description: 'Working capital financing for small traders and hawkers. Fast disbursement process.', icon: Banknote, logo: null, brandColor: '#1a5276' },
  { id: 8, name: 'SME Bank Financing', provider: 'SME Bank', maxAmount: 500000, rate: '5% p.a.', minScore: 720, type: 'Business', tenure: '10 years', description: 'Comprehensive business financing for established SMEs. Includes trade financing and working capital.', icon: Building2, logo: 'https://img.logo.dev/smebank.com.my?token=pk_free', brandColor: '#00695c' },
]
