...
const navItems = [
  ...
  { label: 'Marketplace', icon: BarChart3, path: '/marketplace', active: true },
            ...
            {navItems.map((item) => {
              ...
              return (
                <Link
                  key={item.label}
                  to={item.path}
                  className={`flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all ${item.active ? navActive : navInactive}`}
                >
                  <Icon size={18} />
