...
const products = [
  ...
  { id: 4, name: 'MARA Business Financing', provider: 'MARA', maxAmount: 200000, rate: '3.5% p.a.', minScore: 70, type: 'Business', tenure: '10 years', description: 'Business development financing for Bumiputera SMEs. Includes business advisory services.', icon: Briefcase, logo: 'https://img.logo.dev/mara.gov.my?token=pk_free', brandColor: '#1565c0' },
  { id: 5, name: 'Bank Rakyat Personal', provider: 'Bank Rakyat', maxAmount: 150000, rate: '5.5% p.a.', minScore: 80, type: 'Personal', tenure: '10 years', description: 'Personal financing with competitive rates. Available for salaried and self-employed individuals.', icon: CreditCard, logo: 'https://img.logo.dev/bankrakyat.com.my?token=pk_free', brandColor: '#6B2D8B' },
  { id: 6, name: 'PTPTN Education', provider: 'PTPTN', maxAmount: 60000, rate: '1% p.a.', minScore: 40, type: 'Education', tenure: '15 years', description: 'Education loan for Malaysian students pursuing higher education at recognized institutions.', icon: GraduationCap, logo: 'https://img.logo.dev/ptptn.gov.my?token=pk_free', brandColor: '#0d47a1' },
