      ...
      <main className="max-w-5xl mx-auto px-6 py-10">
        ...
        >
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-sm text-emerald-400 font-medium">{t('learnHeroLabel')}</span>
          </div>
        ...
        >
          <div className="relative">
            ...
            <input
              ...
              className={`w-full pl-10 pr-4 py-3 rounded-xl border text-sm ${inputBg} outline-none focus:ring-2 focus:ring-emerald-500/30`}
            />
          </div>
              ...
              <button
                ...
                className={`px-4 py-1.5 rounded-full text-xs font-medium border transition-all ${
                  activeCategory === cat.key
                    ...
                    : `${theme === 'dark' ? 'border-[#2a2a2a] text-gray-400 hover:border-emerald-500/50' : 'border-gray-200 text-gray-500 hover:border-emerald-300'}`
                }`}
              >
                {cat.label}
              </button>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className={`mt-12 p-8 rounded-2xl border text-center bg-gradient-to-br from-emerald-500/10 to-teal-500/5 ${theme === 'dark' ? 'border-emerald-500/20' : 'border-emerald-200'}`}
        >
          ...
          <Link
            to="/score"
            className="inline-flex items-center gap-2 px-8 py-3 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-500 text-white font-semibold hover:opacity-90 transition-opacity"
          >
            {t('learnCtaBtn')} →
          </Link>
        </motion.div>
